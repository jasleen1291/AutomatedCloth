...
public class panel4 extends JPanel {
    ...
    panel4() {
        int e = 0, f = 10;
        JLabel bg = new JLabel(new ImageIcon(getClass().getResource("/images/female.jpg")));
        bg.setLayout(null);
        for (int r = 0; r < 2; r++) {
                ...
                public void actionPerformed(ActionEvent e) {
                        ...
                        for (int q = 0; q <= 4; q++) {
                            if (color[q].isSelected()) {
                                try {
                                    ...
                                    Query = "select id from items where category like'women'&& color like '" + col[q] + "' ";
                    ...
                    if (dept[1].isSelected()) {
                        try {
                            ...
                            int i = cntr;
                            st = con.createStatement();
                            Query = "select id from items where category like'women'&& color like 'jean'";
                            rs = st.executeQuery(Query);
